...
const Sidebar = ({ isOpen, toggleSidebar,setActiveComponent }) => {
  ...
  return (
    <section>
      ...
      <div className={`w-[250px] bg-[#323232] flex flex-col justify-between max-h-screen h-[760px] mx-4 mt-4 rounded-2xl opacity-80 border border-gray-500 shadow-xl transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-[98%]'}`}>
