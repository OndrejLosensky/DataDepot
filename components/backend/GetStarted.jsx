...
const GetStarted = () => {
  return (
    <div className='w-full flex flex-col items-center'>
        <p className='py-2 mx-auto bg-slate-800 shadow-md border border-gray-600 mt-24 rounded-full'>  <span className='px-4 ml-2 rounded-full bg-violet-600 drop-shadow-glow2 text-violet-100 py-1'> new </span>  <span className='px-4 text-gray-400 hover:text-gray-300 duration-200 '> Introducing DataDefender Algorithms </span></p>
        <h1 className='text-4xl font-bold pt-12 text-gray-200'>Meet DataDepot</h1>
        ...
        <div className='grid grid-cols-2 w-1/2  gap-6 mt-8'>
            ...
            <div className='w-full cursor-pointer hover:border-gray-300 duration-300 hover:scale-105  h-24 rounded-md shadow-lg border border-gray-500 flex flex-row items-center justify-between px-6'>
                <FaBolt className='w-6 h-6 text-gray-100'/>
                Instalation
                <MdOutlineKeyboardArrowRight/>
            </div>
            <div className='w-full cursor-pointer hover:border-gray-300 duration-300 hover:scale-105  h-24 rounded-md shadow-lg border border-gray-500 flex flex-row items-center justify-between px-6'>
