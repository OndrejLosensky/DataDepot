...
const GetStarted = ({setActiveComponent}) => {
  ...
  return (
    <div className='w-full flex flex-col items-center'>
        ...
        <div className='grid grid-cols-2 w-1/2  gap-6 mt-8'>
            <div onClick={() => setActiveComponent('Analytics')} className='w-full cursor-pointer hover:border-gray-300 duration-300 hover:scale-105  h-20   rounded-md shadow-lg border border-gray-500 flex flex-row items-center justify-between px-6'>
                <FaHome className='w-6 h-6 text-gray-100'/>
                Getting started
                <MdOutlineKeyboardArrowRight/>
            </div>
            <div onClick={() => setActiveComponent('')} className='w-full cursor-pointer hover:border-gray-300 duration-300 hover:scale-105  h-20 rounded-md shadow-lg border border-gray-500 flex flex-row items-center justify-between px-6'>
            ...
            <div onClick={() => setActiveComponent('PasswordManager')} className='w-full cursor-pointer hover:border-gray-300 duration-300 hover:scale-105  h-20 rounded-md shadow-lg border border-gray-500 flex flex-row items-center justify-between px-6'>
                <MdLockOutline className='w-6 h-6 text-gray-100'/>
                Passwords Storage
                <MdOutlineKeyboardArrowRight/>
            </div>
            <div onClick={() => setActiveComponent('CodeSnippets')} className='w-full cursor-pointer hover:border-gray-300 duration-300 hover:scale-105  h-20 rounded-md shadow-lg border border-gray-500 flex flex-row items-center justify-between px-6'>
                <FaCode className='w-6 h-6 text-gray-100'/>
                Coding Snippets
                <MdOutlineKeyboardArrowRight/>
            </div>
            <div onClick={() => setActiveComponent('Notes')} className='w-full cursor-pointer hover:border-gray-300 duration-300 hover:scale-105  h-20 rounded-md shadow-lg border border-gray-500 flex flex-row items-center justify-between px-6'>
