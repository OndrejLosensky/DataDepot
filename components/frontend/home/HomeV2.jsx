  ...
  return (
    <div className='min-h-screen h-auto overflow-hidden max-w-screen'>
      ...
      <section className='flex justify-center items-center'>
        <div className='mx-auto w-screen mt-14 md:space-y-16 flex flex-row items-center justify-between'>
          ...
          <div className='w-[60%] relative pb-32'> 
              <div className='rounded-lg'>
                <img src='/editor.png' alt="dashboard image" className='translate-x-40 pt-20 w-[1400px] h-[780px] rounded-lg' />
              </div>
          </div>
        </div>
      </section>
