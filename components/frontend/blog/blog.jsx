    ...
    <div className='max-w-screen min-h-screen overflow-hidden text-white'>
      ...
      <div className='w-3/4 mx-auto mt-12'>
        ...
        <p className='text-xl font-light mb-8'>
          ...
          Whether you are a seasoned user or new to DataDepot, our blog is designed to keep you informed and inspired. Dive into our posts to learn about our newest features, upcoming events, and industry trends.
          We are committed to providing you with valuable content that empowers you to make the most of our platform. Join us on this journey as we explore the endless possibilities of data management and analysis.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-12">
          {blogPosts.map((post, index) => (
            <div key={index} className='bg-[#262626] border border-gray-500 hover:drop-shadow-glow cursor-pointer duration-300 rounded-lg p-4'>
              <div className="mb-4">
                <Image height={300} width={600} src="/blog_test.jpeg" alt={`Image ${index+1}`} className='w-full h-[300px] object-cover rounded-md' />
              </div>
